...
int main(int argc, char* argv[])
{
  ...
  K_surf = fabs(0.5*((P2[0]-P1[0])*(P3[1]-P1[1]) - (P2[1]-P1[1])*(P3[0]-P1[0])));
  if(K_surf < 1e-14){printf("ERROR SURFACE NULLE"); break;}

  Qal[iTri] = alpha *(a+b+c)/K_surf; 
  // printf("%d quality evaluated at : %lg \n", iTri, Qal[iTri]);
  }
